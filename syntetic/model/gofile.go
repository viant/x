...
type RenderOptions struct {
	// Header is prepended before the package declaration (e.g., "// Code generated by ... DO NOT EDIT.").
	// When non-empty, a trailing newline is added automatically.
	Header string
...
func (f *GoFile) RenderWithOptions(opts RenderOptions) (string, error) {
	...
	if opts.Header != "" {
		...
		if opts.Header[len(opts.Header)-1] != '\n' {
			buf.WriteByte('\n')
		}
		buf.WriteByte('\n')
	}
